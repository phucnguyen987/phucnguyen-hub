-- [[ PHUC NGUYEN X HUB - FINAL V10.8 - SPEED LIMIT 800 ]] --

-- === [ HỆ THỐNG KIỂM TRA PHIÊN BẢN ] ===
local CurrentVersion = 10.8
...
-- [CẬP NHẬT] Thanh chỉnh tốc độ tối đa lên 800
AddSlider("Tốc Độ", "WalkSpeed", 16, 800)
...
Notify("PHUC NGUYEN HUB V10.8 - SPEED MAX 800!")
