-- [[ PHUC NGUYEN X HUB - FINAL V10.2 - RECOVER DRAG & GUI LOGIC ]] --
...
-- [[ LOGIC TRỌNG TÂM: AUTO KILL + SINK + NOTIFY ]] --
spawn(function()
    local Angle = 0
    local SafeY = nil
        ...
        pcall(function()
            ...
            if Char and Char:FindFirstChild("Humanoid") and Char:FindFirstChild("HumanoidRootPart") then
                ...
                if IsRagdoll and not getgenv().Config.SkyWalk then
                    ...
                    if getgenv().TargetKill then KillStatus.Text = ">>> ĐANG LÚN NÉ ĐÒN <<<" end
                else
                    if SafeY then
                        MyRoot.CFrame = CFrame.new(MyRoot.Position.X, SafeY + 2, MyRoot.Position.Z)
                        SafeY = nil
                        StandUp()
                    end
                    ...
                    if getgenv().TargetKill then
                        ...
                        if Target and Target.Character and Target.Character:FindFirstChild("Humanoid") and Target.Character:FindFirstChild("HumanoidRootPart") then
                            ...
                            elseif TarHum.Health > 0 then
                                ...
                                KillStatus.Text = ">>> ĐANG SĂN: " .. Target.Name .. " <<<"
                                MyRoot.AssemblyLinearVelocity = Vector3.zero
...
Notify("PHUC NGUYEN HUB V10.2 - DRAG & LOGIC RECOVERED!")
