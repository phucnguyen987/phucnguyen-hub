...
-- ==========================================
-- 1. HÀM LƯU/LOAD (ĐÃ FIX: KHÔNG LOAD SIZE)
-- ==========================================
    ...
    for _, v in pairs(ScreenGui:GetChildren()) do
        if v:IsA("TextButton") and v.Name:find("Key_") then
            Data[v.Name] = {
                ...
                -- Không cần lưu Size để tránh ghi đè sai thông số mặc định
            }
        end
    end
...
local function LoadFromHardware()
    ...
    for name, p in pairs(Data) do
        ...
        if btn then
            -- Chỉ load vị trí (Position), kích thước (Size) sẽ giữ theo code mặc định
...
-- ĐÃ FIX: Độ dài SPACE mặc định là 100
...
TopBar.Position = UDim2.new(0.15, 0, 0.8, 0)
...
MenuBtn.Position = UDim2.new(0.42, 0, 0.93, 0)
